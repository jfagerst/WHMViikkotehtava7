...
Application should contain some logic beyond just displaying simple data (random cat etc.). For example, it could be an app retrieving weather based on location (GPS or location typed by user).

Do not use any API, that requires payment (or using credit card for signup). 
